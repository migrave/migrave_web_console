! function() {
    ...
    2: [function(a, b, c) {
        (function(a) {
            ! function(d) {
                ...
                function f(a) {
                    a ? (this._conf = a, a.delimiter && (this.delimiter = a.delimiter), this._maxListeners = a.maxListeners !== d ? a.maxListeners : l, a.wildcard && (this.wildcard = a.wildcard), a.newListener && (this.newListener = a.newListener), a.verboseMemoryLeak && (this.verboseMemoryLeak = a.verboseMemoryLeak), this.wildcard && (this.listenerTree = {})) : this._maxListeners = l
                }
                ...
                function g(b, c) {
                    ...
                    if (this.verboseMemoryLeak && (d += " Event name: " + c + "."), "undefined" != typeof a && a.emitWarning) {
                        var e = new Error(d);
                        e.name = "MaxListenersExceededWarning", e.emitter = this, e.count = b, a.emitWarning(e)
                    } else console.error(d), console.trace && console.trace()
                }

                function h(a) {
                    this._events = {}, this.newListener = !1, this.verboseMemoryLeak = !1, f.call(this, a)
                }
                ...
                function i(a, b, c, d) {
                    ...
                    if ("*" === o || "**" === o || c[o]) {
                        if ("*" === o) {
                            for (g in c) "_listeners" !== g && c.hasOwnProperty(g) && (m = m.concat(i(a, b, c[g], d + 1)));
                            return m
                        }
                        if ("**" === o) {
                            l = d + 1 === n || d + 2 === n && "*" === p, l && c._listeners && (m = m.concat(i(a, b, c, n)));
                            for (g in c) "_listeners" !== g && c.hasOwnProperty(g) && ("*" === g || "**" === g ? (c[g]._listeners && !l && (m = m.concat(i(a, b, c[g], n))), m = m.concat(i(a, b, c[g], d))) : m = g === p ? m.concat(i(a, b, c[g], d + 2)) : m.concat(i(a, b, c[g], d)));
                            return m
                        }
                    ...
                    if (h = c["*"], h && i(a, b, h, d + 1), j = c["**"])
                        if (d < n) {
                            ...
                            for (g in j) "_listeners" !== g && j.hasOwnProperty(g) && (g === p ? i(a, b, j[g], d + 2) : g === o ? i(a, b, j[g], d + 1) : (k = {}, k[g] = j[g], i(a, b, {
                                "**": k
                            }, d + 1)))
                        } else j._listeners ? i(a, b, j, n) : j["*"] && j["*"]._listeners && i(a, b, j["*"], n);
                    return m
                }
                ...
                function j(a, b) {
                    ...
                    for (var f = this.listenerTree, h = a.shift(); h !== d;) {
                        if (f[h] || (f[h] = {}), f = f[h], 0 === a.length) return f._listeners ? ("function" == typeof f._listeners && (f._listeners = [f._listeners]), f._listeners.push(b), !f._listeners.warned && this._maxListeners > 0 && f._listeners.length > this._maxListeners && (f._listeners.warned = !0, g.call(this, f._listeners.length, h))) : f._listeners = b, !0;
                        h = a.shift()
                    }
                    return !0
                }
                var k = Array.isArray ? Array.isArray : function(a) {
                        return "[object Array]" === Object.prototype.toString.call(a)
                    },
                    l = 10;
                h.EventEmitter2 = h, h.prototype.delimiter = ".", h.prototype.setMaxListeners = function(a) {
                    a !== d && (this._maxListeners = a, this._conf || (this._conf = {}), this._conf.maxListeners = a)
                }, h.prototype.event = "", h.prototype.once = function(a, b) {
                    ...
                    var b, c, d, f, g, h = arguments.length;
                    if (this._all && this._all.length) {
                        if (g = this._all.slice(), h > 3)
                            for (b = new Array(h), f = 0; f < h; f++) b[f] = arguments[f];
                        for (d = 0, c = g.length; d < c; d++) switch (this.event = a, h) {
                            case 1:
                                g[d].call(this, a);
                                break;
                            case 2:
                        ...
                        if (g = this._events[a], "function" == typeof g) {
                            switch (this.event = a, h) {
                                ...
                                case 3:
                                    ...
                                    break;
                                default:
                                    for (b = new Array(h - 1), f = 1; f < h; f++) b[f - 1] = arguments[f];
                                    g.apply(this, b)
                            }
                            return !0
                        }
                    ...
                    if (this._all) {
                        ...
                        for (d = 0, c = this._all.length; d < c; d++) switch (this.event = a, j) {
                            case 1:
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                h.push(this._all[d].call(this, a, arguments[1], arguments[2]));
                                break;
                            default:
                    ...
                    if ("function" == typeof g) switch (this.event = a, j) {
                        ...
                        if (g = g.slice(), j > 3)
                            for (b = new Array(j - 1), f = 1; f < j; f++) b[f - 1] = arguments[f];
                        for (d = 0, c = g.length; d < c; d++) switch (this.event = a, j) {
                            case 1:
                ...
                }, h.prototype.addListener = h.prototype.on, h.prototype._onAny = function(a, b) {
                    if ("function" != typeof a) throw new Error("onAny only accepts instances of Function");
                    return this._all || (this._all = []), b ? this._all.unshift(a) : this._all.push(a), this
                    ...
                    function c(a) {
                        if (a !== d) {
                            ...
                            for (var e in b) {
                                var f = b[e],
                                    g = a[f];
                                g instanceof Function || "object" != typeof g || null === g || (Object.keys(g).length > 0 && c(a[f]), 0 === Object.keys(g).length && delete a[f])
                            }
                        }
                    }
                    ...
                    for (var h = 0; h < f.length; h++) {
                        ...
                        if (e = j._listeners, k(e)) {
                            for (var l = -1, m = 0, n = e.length; m < n; m++)
                                if (e[m] === b || e[m].listener && e[m].listener === b || e[m]._origin && e[m]._origin === b) {
                                    l = m;
                                    break
                                } if (l < 0) continue;
                            return this.wildcard ? j._listeners.splice(l, 1) : this._events[a].splice(l, 1), 0 === e.length && (this.wildcard ? delete j._listeners : delete this._events[a]), this.emit("removeListener", a, b), this
                        }(e === b || e.listener && e.listener === b || e._origin && e._origin === b) && (this.wildcard ? delete j._listeners : delete this._events[a], this.emit("removeListener", a, b))
                    }
                    ...
                    return this
                }, h.prototype.removeListener = h.prototype.off, h.prototype.removeAllListeners = function(a) {
                    if (0 === arguments.length) return !this._events || e.call(this), this;
                    if (this.wildcard)
                        for (var b = "string" == typeof a ? a.split(this.delimiter) : a.slice(), c = i.call(this, null, b, this.listenerTree, 0), d = 0; d < c.length; d++) {
                            var f = c[d];
                            f._listeners = null
                    ...
                    return this._events || e.call(this), this._events[a] || (this._events[a] = []), k(this._events[a]) || (this._events[a] = [this._events[a]]), this._events[a]
                    ...
                    return h
                }) : "object" == typeof c ? b.exports = h : window.EventEmitter2 = h
            }()
    ...
    19: [function(a, b, c) {
        function d(a) {
            ...
            } : this.callForSubscribeAndAdvertise = this.ros.callOnConnection, this._messageCallback = function(a) {
    ...
    41: [function(a, b, c) {
        ...
        function e(a) {
            d();
            for (var b = a.byteLength, c = a.byteOffset, e = b / 8, f = a.buffer.slice(c, c + b), g = new Uint32Array(f), h = new Array(e), j = 0; j < e; j++) {
                var k = 2 * j,
                    l = g[k],
                    m = g[k + 1];
                h[j] = l + i * m
        ...
        function f(a) {
            d();
            for (var b = a.byteLength, c = a.byteOffset, e = b / 8, f = a.buffer.slice(c, c + b), g = new Uint32Array(f), h = new Int32Array(f), j = new Array(e), k = 0; k < e; k++) {
                var l = 2 * k,
                    m = g[l],
                    n = h[l + 1];
                j[k] = m + i * n
